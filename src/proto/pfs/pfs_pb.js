...
proto.pfs_v2.SQLDatabaseEgress.Secret.toObject = function(includeInstance, msg) {
  var f, obj = {
    k8sSecret: jspb.Message.getFieldWithDefault(msg, 1, ""),
...
/**
 * optional string k8s_secret = 1;
 * @return {string}
 */
proto.pfs_v2.SQLDatabaseEgress.Secret.prototype.getK8sSecret = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.pfs_v2.SQLDatabaseEgress.Secret.prototype.setK8sSecret = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
